...
HD_PWD='C:/Users/Dhwanil/Desktop/fpga_2.0/hardware_accelerator/hardware_accelerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log heart_risk_bram_accelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source heart_risk_bram_accelerator.tcl
