...
REM
REM Generated by Vivado on Fri Apr 17 21:33:28 +0530 2026
...
echo "xvlog --incr --relax -prj tb_heart_risk_vlog.prj"
call xvlog  --incr --relax -prj tb_heart_risk_vlog.prj -log xvlog.log
